...
public interface IMusic {
    ...
    public static IMusic chooseModule(CVarManager CVM) {
        ...
        } else if ("true".equals(System.getProperty("java.awt.headless"))) {
            // Phase 4.3: Headless mode — capture MUS data for browser nuked-opl3 playback
            System.out.println("IMusic: Headless mode detected, using HeadlessMusicDriver");
            return new HeadlessMusicDriver();
        } else {
